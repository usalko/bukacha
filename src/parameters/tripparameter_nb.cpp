...
void init_TripParameters(nb::module_ &m)
{
    ...
    nb::enum_<TripParameters::SourceType>(m, "SourceType", "enum-level docstring")
        .value("Any", TripParameters::SourceType::Any, "Any")
        .value("First", TripParameters::SourceType::First, "First")
        .export_values();

    nb::enum_<TripParameters::DestinationType>(m, "DestinationType", "enum-level docstring")
        .value("Any", TripParameters::DestinationType::Any, "Any")
        .value("Last", TripParameters::DestinationType::Last, "Last")
        .export_values();
    ...
    nb::class_<TripParameters, RouteParameters>(m, "TripParameters")
        ...
        .def(
               ...
               const BaseParameters::SnappingType snapping)
            {
                ...
                osrm_nb_util::assign_routeparameters(
                    t,
                    steps,
                ...
                osrm_nb_util::assign_baseparameters(
                    t,
                    coordinates,
                    hints,
                    radiuses,
