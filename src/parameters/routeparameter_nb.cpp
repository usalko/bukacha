...
void init_RouteParameters(nb::module_ &m)
{
    ...
    nb::enum_<RouteParameters::GeometriesType>(m, "GeometriesType", "enum-level docstring")
        .value("Polyline", RouteParameters::GeometriesType::Polyline, "Polyline")
        .value("Polyline6", RouteParameters::GeometriesType::Polyline6, "Polyline6")
        .value("GeoJSON", RouteParameters::GeometriesType::GeoJSON, "GeoJSON")
        .export_values();

    nb::enum_<RouteParameters::OverviewType>(m, "OverviewType", "enum-level docstring")
        .value("Simplified", RouteParameters::OverviewType::Simplified, "Simplified")
        .value("Full", RouteParameters::OverviewType::Full, "Full")
        .value("False", RouteParameters::OverviewType::False, "False")
        .export_values();

    nb::enum_<RouteParameters::AnnotationsType>(m, "Flag", "enum-level docstring")
        .value("None", RouteParameters::AnnotationsType::None, "None")
        .value("Duration", RouteParameters::AnnotationsType::Duration, "Duration")
        .value("Nodes", RouteParameters::AnnotationsType::Nodes, "Nodes")
        .value("Distance", RouteParameters::AnnotationsType::Distance, "Distance")
        .value("Weight", RouteParameters::AnnotationsType::Weight, "Weight")
        .value("Datasources", RouteParameters::AnnotationsType::Datasources, "Datasources")
        .value("Speed", RouteParameters::AnnotationsType::Speed, "Speed")
        .value("All", RouteParameters::AnnotationsType::All, "All")
        .export_values();
    ...
    nb::class_<RouteParameters, BaseParameters>(m, "RouteParameters")
        ...
        .def(
            ...
            "exclude"_a = nb::cast(std::vector<std::string>()),
    ...
    //         new (t) RouteParameters::GeometriesType(geometries); }, "Instantiates a GeometriesType based on provided String value.")
    //     .def("__repr__", [](RouteParameters::GeometriesType type)
    //          { return osrm_nb_util::enum_to_str(type, "RouteGeometriesType", geometries_map); }, "Return a String based on GeometriesType value.");
    ...
    //         new (t) RouteParameters::OverviewType(overview); }, "Instantiates a OverviewType based on provided String value.")
    //     .def("__repr__", [](RouteParameters::OverviewType type)
    //          { return osrm_nb_util::enum_to_str(type, "RouteOverviewType", overview_map); }, "Return a String based on OverviewType value.");
    ...
    //         new (t) RouteParameters::AnnotationsType(annotation); }, "Instantiates a AnnotationsType based on provided String value.")
    //     .def("__repr__", [](RouteParameters::AnnotationsType type)
    //          { return std::to_string((int)type); }, "Return a String based on AnnotationsType value.")
    //     .def("__and__", [](RouteParameters::AnnotationsType lhs, RouteParameters::AnnotationsType rhs)
    //          { return lhs & rhs; }, nb::is_operator(), "Return the bitwise AND result of two AnnotationsTypes.")
    //     .def("__or__", [](RouteParameters::AnnotationsType lhs, RouteParameters::AnnotationsType rhs)
    //          { return lhs | rhs; }, nb::is_operator(), "Return the bitwise OR result of two AnnotationsTypes.")
    //     .def("__ior__", [](RouteParameters::AnnotationsType &lhs, RouteParameters::AnnotationsType rhs)
    //          { return lhs = lhs | rhs; }, nb::is_operator(), "Add the bitwise OR value of another AnnotationsType.");
